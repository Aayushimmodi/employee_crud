...
<body style="margin:20px;">
    ...
    @endif
    <form class="row g-3" style="width: 50%;margin:20px;" method="post" action="{{route('employee.store')}}">
        @csrf
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <input type="number" class="form-control" id="emp_mobile" name="emp_mobile">
        </div>
        <div class="col-md-6">
